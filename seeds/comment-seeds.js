...
const commentdata = [
  {
    comment_text: 'magic is when people help people help people help people help people succeed',
    user_id: 6,
    post_id: 1
  },
  {
  ...
  {
    comment_text: 'Always pay it forward to keep the positive energy flowing',
    user_id: 6,
    post_id: 7
  },
  {
  ...
  {
    comment_text: 'The only way to achieve the impossible is to believe it is possible.',
    user_id: 10,
    post_id: 1
  },
  {
    comment_text: 'Every problem has a solution, you just have to be willing to find it.',
    user_id: 2,
    post_id: 19
  },
  {
    comment_text: 'If enough of us would stop saying "I am only one person, I cannot make a difference, there would be enough of us to make a difference.',
    user_id: 10,
    post_id: 1
  },
  {
    comment_text: 'A chance not take is an opportunity missed',
    user_id: 10,
    post_id: 12
  }
];
